...
(function () {
  ...
  function loadSettings() {
    ...
    if (stored.disableArrowKeys !== undefined) {
      if (stored.disableHorizontalArrows === undefined)
        stored.disableHorizontalArrows = stored.disableArrowKeys;
      if (stored.disableVerticalArrows === undefined)
        stored.disableVerticalArrows = stored.disableArrowKeys;
    }
  ...
  function handleHotkeyEvent(e) {
    ...
    if (
      currentSettings.disableCtrlLeft &&
      e.ctrlKey &&
      e.code === "ArrowLeft"
    ) {
      block();
    ...
    if (
      currentSettings.disableCtrlRight &&
      e.ctrlKey &&
      e.code === "ArrowRight"
    ) {
      block();
    ...
    if (
      currentSettings.disableFastForwardL &&
      (e.key === "l" || e.key === "L")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disablePreviousVideoP &&
      e.shiftKey &&
      (e.key === "p" || e.key === "P")
    ) {
      block();
    ...
    if (
      currentSettings.disableNextVideoN &&
      e.shiftKey &&
      (e.key === "n" || e.key === "N")
    ) {
      block();
    ...
    if (
      currentSettings.disableShiftSlash &&
      e.shiftKey &&
      (e.key === "?" || e.key === "/")
    ) {
      block();
    ...
    if (
      currentSettings.disableTheatreModeT &&
      (e.key === "t" || e.key === "T")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disableMiniPlayerI &&
      (e.key === "i" || e.key === "I")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disableCloseDialogEsc &&
    ...
    if (
      currentSettings.disableTextOpacityO &&
      (e.key === "o" || e.key === "O")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disableWindowOpacityW &&
      (e.key === "w" || e.key === "W")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disableFontIncrease &&
      (e.key === "+" || e.key === "=")
    ) {
      block();
      return;
    ...
    if (
      currentSettings.disableFontDecrease &&
      (e.key === "-" || e.key === "_")
    ) {
      block();
      return;
  ...
  function openSettings() {
    ...
    const resetSettings = () => {
      ...
      [
        ...document.querySelectorAll(".yt-hk-row input[type='checkbox']"),
      ].forEach((checkbox) => {
    ...
    const baseOptions = [
      {
        ...
        checked: liveSettings.disableNumericKeys,
      },
      {
        id: "disableSpacebar",
        label: "Disable Spacebar",
        checked: liveSettings.disableSpacebar,
      },
      {
        id: "disableHorizontalArrows",
        label: "Disable Progress Forward / Rewind (← →)",
        checked: liveSettings.disableHorizontalArrows,
      },
      {
        id: "disableVerticalArrows",
        label: "Disable Volume Up / Down (↑ ↓)",
        checked: liveSettings.disableVerticalArrows,
      },
      {
        id: "disableCtrlLeft",
        label: "Disable (Ctrl + Left)",
        checked: liveSettings.disableCtrlLeft,
      },
      {
        id: "disableCtrlRight",
        label: "Disable Ctrl + Right",
        checked: liveSettings.disableCtrlRight,
      },
      {
        id: "disableFKey",
        label: 'Disable "F" (Fullscreen)',
        checked: liveSettings.disableFKey,
      },
      {
        id: "disableMKey",
        label: 'Disable "M" (Mute)',
        checked: liveSettings.disableMKey,
      },
      {
        id: "disableVKey",
        label: 'Disable "V" (Captions toggle)',
        checked: liveSettings.disableVKey,
      },
      {
        id: "disableSpeedControl",
        label: "Disable Speed (Shift+<>)",
        checked: liveSettings.disableSpeedControl,
      },
      {
        id: "disableFrameSkip",
        label: "Disable Frame Skip (./,)",
        checked: liveSettings.disableFrameSkip,
      },
    ];
    ...
    const advancedOptions = [
      {
        ...
        label: "Play/Pause (k)",
        checked: liveSettings.disablePlayPauseK,
      },
      {
        id: "disableRewindJ",
        label: "Rewind (j)",
        checked: liveSettings.disableRewindJ,
      },
      {
        id: "disableFastForwardL",
        label: "Fast Forward (l)",
        checked: liveSettings.disableFastForwardL,
      },
      {
        id: "disablePreviousVideoP",
        label: "Previous Video (Shift+p)",
        checked: liveSettings.disablePreviousVideoP,
      },
      {
        id: "disableNextVideoN",
        label: "Next Video (Shift+n)",
        checked: liveSettings.disableNextVideoN,
      },
      {
        id: "disableTheatreModeT",
        label: "Theatre Mode (t)",
        checked: liveSettings.disableTheatreModeT,
      },
      {
        id: "disableMiniPlayerI",
        label: "Miniplayer (i)",
        checked: liveSettings.disableMiniPlayerI,
      },
      {
        id: "disableCloseDialogEsc",
        label: "Escape (close dialog)",
        checked: liveSettings.disableCloseDialogEsc,
      },
      {
        id: "disableCaptionsC",
        label: "Captions (c)",
        checked: liveSettings.disableCaptionsC,
      },
      {
        id: "disableTextOpacityO",
        label: "Text Opacity (o)",
        checked: liveSettings.disableTextOpacityO,
      },
      {
        id: "disableWindowOpacityW",
        label: "Window Opacity (w)",
        checked: liveSettings.disableWindowOpacityW,
      },
      {
        id: "disableFontIncrease",
        label: "Font Size + (+)",
        checked: liveSettings.disableFontIncrease,
      },
      {
        id: "disableFontDecrease",
        label: "Font Size - (-)",
        checked: liveSettings.disableFontDecrease,
      },
      {
        id: "disablePanUpW",
        label: "Pan Up (w)",
        checked: liveSettings.disablePanUpW,
      },
      {
        id: "disablePanLeftA",
        label: "Pan Left (a)",
        checked: liveSettings.disablePanLeftA,
      },
      {
        id: "disablePanDownS",
        label: "Pan Down (s)",
        checked: liveSettings.disablePanDownS,
      },
      {
        id: "disablePanRightD",
        label: "Pan Right (d)",
        checked: liveSettings.disablePanRightD,
      },
      {
        id: "disableZoomIn",
        label: "Zoom In (+ or ])",
        checked: liveSettings.disableZoomIn,
      },
      {
        id: "disableZoomOut",
        label: "Zoom Out (- or [)",
        checked: liveSettings.disableZoomOut,
      },
      {
        id: "disableShiftSlash",
        label: "Keyboard Shortcuts (Shift+/)",
        checked: liveSettings.disableShiftSlash,
      },
    ];
    ...
    saveBtn.onclick = () => {
      ...
      const mergedSettings = persistSettings({
        ...liveSettings,
        ...newSettings,
      });
